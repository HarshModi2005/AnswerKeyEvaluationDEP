        ...
        <div className="space-y-6">
                    ...
                    <div className="flex-1">
                        ...
                        <div className="flex justify-between items-center mt-3">
                            ...
                            <button
                                ...
                                className={`px-4 py-2 rounded-lg transition-colors duration-200 ${!newComment.trim() || isSubmitting
            ...
            <div className="space-y-4">
                {comments.map((comment) => (
                    <div
                        key={comment.id}
                        className={`flex items-start space-x-3 p-4 border rounded-lg ${comment.isNew ? 'border-primary-100 bg-primary-50' : 'border-border'
                            }`}
                    >
