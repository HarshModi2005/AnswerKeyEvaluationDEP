                    ...
                    {!isEditing && (
                        <div className="flex space-x-2">
                            <button
                                ...
                                className={`flex items-center space-x-1 px-3 py-1 rounded-md text-xs font-medium ${showFigma ? 'bg-primary-100 text-primary-700' : 'bg-secondary-100 text-secondary-700 hover:bg-secondary-200'
                            ...
                            <button
                                ...
                                className={`flex items-center space-x-1 px-3 py-1 rounded-md text-xs font-medium ${showLoom ? 'bg-primary-100 text-primary-700' : 'bg-secondary-100 text-secondary-700 hover:bg-secondary-200'
                                    } transition-colors duration-200`}
                            >
