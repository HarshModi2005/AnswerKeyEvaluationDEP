                    ...
                    <div className="border-b border-border bg-secondary-50">
                        <div className="flex">
                            <button
                                ...
                                className={`flex-1 py-4 px-6 text-center font-medium transition-all duration-200 ${activeTab === 'login' ? 'text-primary border-b-2 border-primary bg-surface' : 'text-text-secondary hover:text-text-primary hover:bg-secondary-100'
                                    }`}
                            >
                            ...
                            <button
                                ...
                                className={`flex-1 py-4 px-6 text-center font-medium transition-all duration-200 ${activeTab === 'register' ? 'text-primary border-b-2 border-primary bg-surface' : 'text-text-secondary hover:text-text-primary hover:bg-secondary-100'
                                    }`}
                            >
                                <div className="flex items-center justify-center space-x-2">
